export const SOURCE_REGISTRY = [
  { id:'openai-news', name:'OpenAI News', url:'https://openai.com/news/', feedUrl:'https://openai.com/sitemap.xml', kind:'primary', priority:'P1', adapter:'sitemap', includePath:'openai\\.com/(?:index/)?(?!api|research/index)[^?#]+$', excludePath:'/policies/|/business/|/enterprise/|/chatgpt/', checkMinutes:10, topics:['AI','models','enterprise','infrastructure'] },
  { id:'anthropic-news', name:'Anthropic Newsroom', url:'https://www.anthropic.com/news', feedUrl:'https://www.anthropic.com/sitemap.xml', kind:'primary', priority:'P1', adapter:'sitemap', includePath:'anthropic\\.com/news/', checkMinutes:10, topics:['AI','models','agents','enterprise'] },
  { id:'deepmind-blog', name:'Google DeepMind', url:'https://deepmind.google/blog/', feedUrl:'https://deepmind.google/sitemap.xml', kind:'primary', priority:'P1', adapter:'sitemap', includePath:'deepmind\\.google/(?:discover/blog|blog)/', checkMinutes:15, topics:['AI','research','models','science'] },
