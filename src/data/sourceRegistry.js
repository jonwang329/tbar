export const SOURCE_REGISTRY = [
  { id:'openai-news', name:'OpenAI News', url:'https://openai.com/news/', feedUrl:'https://openai.com/sitemap.xml', kind:'primary', priority:'P1', adapter:'sitemap', includePath:'openai\\.com/index/', excludePath:'/policies/|/business/|/enterprise/|/chatgpt/', checkMinutes:10, topics:['AI','models','enterprise','infrastructure'] },
